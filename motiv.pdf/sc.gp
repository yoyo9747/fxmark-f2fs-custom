# LOG_FILE = logs/fxmark/motiv.log
# SYSTEM = Linux saturn02 6.10.0+ #3 SMP PREEMPT_DYNAMIC Sun Dec  8 11:46:50 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
# DISK_SIZE = 64G
# DURATION = 60s
...
set xlabel '# cores' font ',20'
set ylabel 'M ops/sec' font ',20'
